...
class SimpleRAGPipeline:
    ...
    def _load_and_chunk_documents(self) -> List[Dict[str, Any]]:
        ...
        patterns = [os.path.join(self.samples_dir, "*.md"), os.path.join(self.samples_dir, "*.txt")]
    ...
    def retrieve(self, query: str, top_k: int = 3) -> List[Dict[str, Any]]:
        """Dinamik olarak dokümanları yükleyip kelime eşleşmesine göre RAG retrieval yapar."""
